                    ...
                    <div class="collapse navbar-collapse" id="contenidoNavBar">
                      <ul class="navbar-nav mr-auto">
						...
						<li class="nav-item active">
                          <a class="nav-link" href="Carrito_view.php"><img src="imagenes/carrito-compras.png" style="width:32px"><?php var_dump($_SESSION["idUsuario"]) ?></a>
                        </li>
	...
	<div class="container bg-info">
		...
		<div class="card mb-3" style="max-width: 540px; margin-top:20px;">
			<div class="row no-gutters">
				<div class="col-md-4">
					<img src="imagenes/ejemploArticulo.jpg" class="card-img" alt="...">
				</div>
				<div class="col-md-8">
					<div class="card-body">
						<h5 class="card-title"><?php $articulo->nombreArticulo ?></h5>
							<p class="card-text">Este es un articulo de ejemplo listo para cargar al carrito</p>
							<p class="card-text"></p>
					</div>
				</div>
			</div>
		...
		<ul style="margin:30px;">
			<li>Precio: $0,00</li>
			<li>Stock:  0,00</li>
			<li>Mayorista Min.Unidades: 50 Un.</li>
			<li>Descuento Mayorista: 15%</li>
			<li>Precio Final: $0,00</li>
		</ul>
